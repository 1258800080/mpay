...
class MpayUnitTest extends Command
{
    ...
    private function testSandpayRefundCallbackLifecycle(): void
    {
        ...
        $service = new RefundOrderCallbackService($refundRepository, $payRepository, $manager, $lifecycle);
        $payload = [
            'eventType' => 'refund',
            'mid' => 'SAND-MERCHANT-001',
            'marketProduct' => 'QZF',
    ...
    private function testCashierPaymentStatePresentation(): void
    {
        ...
        $bizOrder->forceFill(['biz_no' => 'B-CASHIER-PUBLIC']);
